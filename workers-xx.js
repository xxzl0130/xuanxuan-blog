...
const github_base = "xxzl0130/xuanxuan-blog";

// 设置站点信息
var default_title	 = "轩轩的技术站 - 半个程序员来记录自己折腾的经历";					// 站点标题（显示在浏览器标题栏）
var default_intitle	 = "轩轩的技术站";								// 站点名称（显示在首页）
var default_description  = "欢迎访问 轩轩醉了 的博客，这里会记录我做的一些软件、研究。"; 	// 站点简介，有利于 SEO
var site_domain		 = "blog.xuanxuan.tech";								// 站点域名
var site_subtitle	 = "半个程序员来记录自己折腾的经历";							// 站点副标题
var static_server = "https://static.xuanxuan.tech";
var site_favicon	 = static_server + "/favicon.ico";				// 站点 Logo
...
<a href="/">返回 ${default_intitle} 首页</a>
	...
	data += `</div>
			...
			<div class="row">
				<div class="col-sm-12">
				<p>Powered by <a href="https://github.com/kasuganosoras/cloudflare-worker-blog" target="_blank">CloudFlare Workers</a> | <a href="https://github.com/xxzl0130/xuanxuan-blog" target="_blank">Github</a></p>
